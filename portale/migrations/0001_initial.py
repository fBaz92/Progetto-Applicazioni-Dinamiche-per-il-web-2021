    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testo', models.CharField(blank=True, max_length=20000, null=True)),
                ('mittenti', models.CharField(blank=True, max_length=200, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ManyToManyField(blank=True, help_text='notices selected by a user', null=True, to='portale.Lesson')),
                ('notice', models.ManyToManyField(blank=True, help_text='notices selected by a user', null=True, to='portale.Notice')),
                ('office_hour', models.ManyToManyField(blank=True, help_text='notices selected by a user', null=True, to='portale.OfficeHour')),
